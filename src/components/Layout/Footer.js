        ...
        <footer className={classes.footer}>
            <div className={classes.michel}>
                <div className={classes.michel_links}>
                    <a href='https://github.com/michel-lamarliere/weather-app-react' target='_blank' rel="noreferrer">
                        <img src={github_icon} alt='github'/>
                    </a>
                    <a href='https://michel-lamarliere.com' target='_blank' rel="noreferrer">
                        <img src={ml_img} alt='michel'/>
                    </a>
                    <a href='https://www.linkedin.com/in/michel-lamarli%C3%A8re-a8394a1b1/' target='_blank' rel="noreferrer">
